...
public class SlideFaceWrtingDto extends BaseDto{
	...
	private List<String> rand_answer1;	  //랜덤 보기
	...
	public List<String> getRand_answer1() {
		return rand_answer1;
	}
	public void setRand_answer1(List<String> rand_answer1) {
		this.rand_answer1 = rand_answer1;
	}
